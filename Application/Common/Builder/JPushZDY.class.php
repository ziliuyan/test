...
class JPushZDY
{
    private $app_key = 'a9614e21b75a0d3882f8eb24';        //待发送的应用程序(appKey)，只能填一个。
    private $master_secret ='f6fe6e1da8ec0de5f4858729';    //主密码
    ...
    */
    ...
    public function push($receiver='all',$content='',$m_type='',$m_txt='',$id='',$m_time='86400'){
        ...
        $data['notification'] = array(
            ...
            "android"=>array(
                ...
                "title"=>"",
                "builder_id"=>1,
                "extras"=>array("type"=>$m_type, "txt"=>$m_txt,"id"=>$id)
            ),
            //ios的自定义
            "ios"=>array(
                "alert"=>$content,
